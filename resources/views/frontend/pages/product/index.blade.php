            ...
            <div class="container">
                <div class="row">
					<div class="col-md-4 col-sm-8 col-xs-12">
											<a href="../index.html" title="Lira textile."><img class="site-logo" src="{{ asset('/frontend/wp-content/uploads/oie_transparent-min.png') }}" alt="Lira textile." /></a>
																</div>
...
<li class="product type-product post-450 status-publish first instock product_cat-women product_tag-wrap-over has-post-thumbnail shipping-taxable product-type-simple">
	<a href="" class="woocommerce-LoopProduct-link woocommerce-loop-product__link"><div class="yith-placeholder"></div><img width="300" height="400" src="{{ asset('/frontend/Lira-tex/man/101.jpeg') }}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" loading="lazy"  sizes="(max-width: 300px) 100vw, 300px" /><h2 class="woocommerce-loop-product__title">1</h2>
</a>
</li>
